...
const Brend = () => {
  ...
  const handleNext = () =>
    setStartIndex((prevIndex) => (prevIndex + 1) % kompaniya.length);
  const handlePrev = () =>
    setStartIndex((prevIndex) => (prevIndex - 1 + kompaniya.length) % kompaniya.length);

  const displayedKomoaniya = [...kompaniya, ...kompaniya].slice(startIndex, startIndex + 3);
      ...
      <div className=" py-[100px]">
        <div className="flex justify-between ">
          <div className="max-w-[1440px] mx-auto p-5 relative">
            <h2 className="mr-[320px] text-[30px] font-medium">Новости <br /> компании</h2>
          </div>

          <div>
            <div className="flex items-center gap-2">
              {displayedKomoaniya.map((kompaniya, index) => (
